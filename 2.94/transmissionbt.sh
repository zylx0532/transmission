...
cd /root
wget -c https://github.com/zylx0532/transmission/master/2.94/intltool-0.40.6.tar.gz --no-check-certificate -O intltool-0.40.6.tar.gz
...
make -s install
cd ..
wget -c https://github.com/zylx0532/transmission/master/2.94/libevent-2.0.21-stable.tar.gz --no-check-certificate -O libevent-2.0.21-stable.tar.gz
...
cd /root
wget -c https://github.com/zylx0532/transmission/master/2.94/transmission-2.94.tar.xz --no-check-certificate -O transmission-2.94.tar.xz
...
wget https://github.com/zylx0532/transmission/master/2.94/transmission.sh --no-check-certificate -O /etc/init.d/transmissiond
chmod 755 /etc/init.d/transmissiond
chkconfig --add transmissiond
chkconfig --level 2345 transmissiond on
mkdir -p /home/transmission/Downloads/
chmod g+w /home/transmission/Downloads/
wget -c https://github.com/zylx0532/transmission/master/2.94/settings.json --no-check-certificate -O settings.json
mkdir -p /home/transmission/.config/transmission/
...
wget -c https://github.com/zylx0532/transmission/master/2.94/index.html --no-check-certificate -O index.html
mv -f index.html /usr/share/transmission/web/index.html
wget -O webgui.sh https://github.com/zylx0532/transmission/master/2.94/webgui.sh --no-check-certificate && bash webgui.sh
